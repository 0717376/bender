...
Архитектурные идеи (изолированные cron-запуски, зеркало доставок, фоновый ревьюер, куратор навыков, замороженный снапшот памяти) вдохновлены [Hermes](https://github.com/NousResearch/hermes-agent).
