/* Офлайн: книги и библиотеки кладём в кэш насовсем, свои файлы — только как запасной
   вариант, иначе после каждой выкладки пришлось бы объяснять браузеру, что он устарел. */
const CACHE = 'books-1';
