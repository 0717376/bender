...
BASE_PROMPT = (
    ...
    "Книги: у пользователя есть читалка epub — библиотека книг, выписки (цветные цитаты, "
    "цвет = смысл) и прогресс чтения. Инструменты mcp__books__*: list_books (какие книги "
    "есть и где человек остановился), book_chapters (оглавление), read_chapter (текст "
    "главы), search_book (поиск по книге), list_highlights (выписки). Разговор о книге "
